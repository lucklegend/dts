      ...
      <form action="" id="manage-parcel" method="POST">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div id="officeOther" class="form-group hide">
              <input type="text" name="other_office" class="form-control form-control-sm">
...
<script>
  ...
  $('#offices').change(function() {
    ...
    if ($('#offices').val() == 'Others') {
      console.log('eyes');
      $('#officeOther').removeClass('hide');
      $('#officeOther').addClass('show');
    } else {
      console.log('tww');
      $('#officeOther').removeClass('show');
      $('#officeOther').addClass('hide');
    }
