          ...
          <div class="col-md-12">
            ...
            <div class="row">
              <div class="col-sm-6 form-group ">
                <label for="" class="control-label">Name of the Office</label>
                <textarea name="name" id="" cols="30" rows="2" class="form-control"><?php echo isset($name) ? $name : '' ?></textarea>
              </div>
              <div class="col-sm-6 form-group ">
            ...
            <div class="row">
              <div class="col-sm-6 form-group ">
                ...
                <textarea name="barangay" id="" cols="30" rows="2" class="form-control"><?php echo isset($barangay) ? $barangay : '' ?></textarea>
              </div>
              <div class="col-sm-6 form-group ">
            ...
            <div class="row">
              <div class="col-sm-6 form-group ">
                <label for="" class="control-label">Province/State</label>
    ...
    $.ajax({
      ...
      success: function(resp) {
        if (resp == 1) {
          ...
          setTimeout(function() {
            location.href = 'index.php?page=office_list'
          }, 2000)
        }
      }
    })
