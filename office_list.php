	...
	<div class="card card-outline card-primary">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary " href="./index.php?page=new_office"><i class="fa fa-plus"></i> Add New</a>
			</div>
		</div>
				...
				<tbody>
					...
					?>
						<tr>
							...
							<td><b><?php echo ucwords($row['street'].','.$row['barangay']) ?></b></td>
							<td><b><?php echo ucwords($row['city'] . ', ' . $row['state'] . ', ' . $row['zip_code']) ?></b></td>
							<td><b><?php echo $row['contact'] ?></b></td>
							<td class="text-center">
								<div class="btn-group">
									<a href="index.php?page=edit_office&id=<?php echo $row['id'] ?>" class="btn btn-primary btn-flat ">
