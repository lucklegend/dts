  ...
  <nav class="main-header navbar navbar-expand navbar-light bg-light">
    ...
    <ul class="navbar-nav ml-auto">
     ...
     <li class="nav-item dropdown">
            <a class="nav-link"  data-toggle="dropdown" aria-expanded="true" href="javascript:void(0)" id="loginText">
              <span>
                <div class="d-felx badge-pill">
                  <span class="fa fa-user mr-2"></span>
                  <span class="login-text"><b><?php echo ucwords($_SESSION['login_firstname']) ?></b></span>
