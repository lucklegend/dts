		...
		<div class="card-body onScroll-x">
			<table class="table tabe-hover table-bordered" id="list">
				...
				<tbody>
					<?php
					$i = 1;
					$type = array('',"Admin","Registrar", "Users");
					$result = $conn->query("SELECT *, CONCAT(lastname,', ',firstname,' ',middlename) as name FROM users WHERE type = 3 ORDER BY CONCAT(lastname,', ',firstname,' ',middlename) ASC");
